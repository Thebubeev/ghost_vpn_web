...
class LandingMobileScreen extends StatelessWidget {
  const LandingMobileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black,
      appBar: const AppBarWidget(textStyle: defaultWhiteMobileTextStyle),
      body: ListView(
        children: const [
          DescriptionWidget(
          ...
          ButtonDocumentWidget(
            ...
            textStyle: defaultBlackMobileTextStyle,
          ),
          SizedBox(
            height: 20,
          ),
